/**
 * Networks Channel Routes
 *
 * Platform-specific channel and message handling for Networks.
 * Routes: /api/v1/networks/channels/*
 *
...
/**
 * GET /api/v1/networks/channels
 * Get all networks channels for current user
 */
router.get(
  "/",
...
/**
 * GET /api/v1/networks/channels/:channelId/messages
 * Get messages for a specific networks channel
 */
router.get(
  "/:channelId/messages",
...
/**
 * POST /api/v1/networks/channels/:channelId/messages
 * Send a message in a networks channel
 */
router.post(
  "/:channelId/messages",
  ...
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      // We need the MongoDB channel ID for sub-services
...
/**
 * POST /api/v1/networks/channels/:channelId/read
 * Mark messages as read in a networks channel
 */
router.post(
  "/:channelId/read",
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
/**
 * DELETE /api/v1/networks/channels/:channelId
 * Archive/Hide a networks channel
 */
router.delete(
  "/:channelId",
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export { router as networksChannelRoutes };
