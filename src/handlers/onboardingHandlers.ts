...
export const onboarding_location_patch = async (
  ...
  try {
    ...
    logger.error("Error saving location step", { error: err });
    next(
      err instanceof AppError
        ? err
        : new DatabaseError("Failed to save location", err),
    );
  }
};
...
export const onboarding_display_name_patch = async (
  ...
  try {
    ...
    next(
      err instanceof AppError
        ? err
        : new DatabaseError("Failed to save display name", err),
    );
  }
};
...
export const onboarding_avatar_patch = async (
  ...
  try {
    ...
    next(
      err instanceof AppError
        ? err
        : new DatabaseError("Failed to save avatar", err),
    );
  }
};
...
export const onboarding_avatar_upload_post = async (
  ...
  try {
    ...
    next(
      err instanceof AppError
        ? err
        : new DatabaseError("Failed to upload avatar", err),
    );
  }
};
...
export const onboarding_acknowledgements_patch = async (
  ...
  try {
    ...
    logger.error("Error saving acknowledgements step", { error: err });
    next(
      err instanceof AppError
        ? err
        : new DatabaseError("Failed to save acknowledgements", err),
    );
  }
};
