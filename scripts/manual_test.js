...
async function runTest() {
  console.log('🧪 Starting "Day in the Life" Manual Test Script (JS Ver)');
  ...
  try {
    ...
    try {
        ...
        console.warn('Could not fetch watches, proceeding with raw body');
    }
    ...
    // "data.channel_id: Save this!"
    // "data.offer.id: Save this!"
    ...
    // Confirm Delivery (Extra step to allow review)
