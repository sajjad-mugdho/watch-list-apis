...
const SELLER_TOKEN = process.env.TEST_SELLER_TOKEN || "";
const BUYER_TOKEN = process.env.TEST_BUYER_TOKEN || "";

if (!SELLER_TOKEN || !BUYER_TOKEN) {
  console.error("Missing TEST_SELLER_TOKEN or TEST_BUYER_TOKEN in environment.");
  process.exit(1);
}
